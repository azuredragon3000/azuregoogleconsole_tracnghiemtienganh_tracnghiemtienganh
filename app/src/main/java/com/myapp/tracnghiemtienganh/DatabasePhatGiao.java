...
public class DatabasePhatGiao extends SQLiteOpenHelper {
    private static final String TABLE_NAM_SINH = "COMPANY";
    ...
    public static final String DB_PATH = "/data/data/com.myapp.tracnghiemtienganh/databases/";
    public static final String DATABASE_NAME = "db_tracnghiemta.db";
    ...
    public Question getQuestion(int num){
        ...
        String snum = String.valueOf(num)+".0";
