...
import com.myapp.tracnghiemtienganh.databinding.FragmentGameFirstBinding;
...
public class FirstFragment extends Fragment  {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        modelFirstFragment.getSelected().observe(getViewLifecycleOwner(), item -> {
            ...
            currentQuestion = getQuestion(item);
    ...
    private Question getQuestion(int index) {
        Question question = databasePhatGiao.getQuestion(index+1);
        return question;
    }
        ...
        alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "OK",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        // clicked = false;
                        //modelSecondFragmentFailed.select(new PassFailed(curLevel,false,index));
                    }
                });
        alertDialog.show();
    }
        ...
        alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "OK",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        // back to thirst
                        dialog.dismiss();
                        modelSecondFragment.select(new PassFailed(curLevel,true,index));
                        NavHostFragment.findNavController(FirstFragment.this)
                                .navigate(R.id.action_FirstFragment_to_SecondFragment);
                    }
                });
